...
<div class="MainPadding">
	...
	?>
			<div class="detail_blurb">
				<p>Banner Image: </p>
				<p><a href="<?php echo $siteUrl . "/" . $row['banner_path'] . "/" . $row['banner_image']; ?>" target="_blank"><img src="<?php echo $siteUrl . "/" . $row['banner_path'] . "/" . $row['banner_image']; ?>" width="125"></a></p>
	...
	?>
			<div class="detail_blurb">
				<p>Eblast Image: </p>
				<p><a href="<?php echo $siteUrl . "/" . $row['eblast_path'] . "/" . $row['eblast_image']; ?>" target="_blank"><img src="<?php echo $siteUrl; ?>/<?php echo $row['eblast_path'] . "/" . $row['eblast_image']; ?>" width="125"></a></p>
	...
	<div class="detail_eblast_html">
			<p>Eblast File: <a href="<?php echo $siteUrl . "/" . $row['eblast_path']; ?>/eblast.htm" target="_blank">Click Here</a></p>
	<?php
